  ...
  if (
    ...
    leftAdornment = (
      <InputAdornment position="start">
        <span className={styles[props.properties.leftAdornment.rootClass]}>
          {`${props.properties.leftAdornment.text}`}
        </span>
      </InputAdornment>
    );
  }
  if (
    ...
    rightAdornment = (
      <InputAdornment
        ...
        position="end"
      >
        <span className={`${props.properties.rightAdornment.iconClass}`} />
      </InputAdornment>
    );
  }
  return (
