...
type PopularMoviesLayoutProps = {};

const PopularMoviesLayout: React.FC<PopularMoviesLayoutProps> = ({}: PopularMoviesLayoutProps) => {
    const [openNavBar, setOpenNavBar] = useState(true);
    const [activeMenu, setActiveMenu] = useState('popularmovies');
